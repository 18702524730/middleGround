    ...
    <div class="form">
      <div class="service_list">
        ...
        <div class="detail_list clearfix">
          <div class="category_left fl clearfix">
            <ul class="fl">
              <li>
                <p class="tit">订单来源</p>
                <p class="txt">{{detailInfo.inputChannelOrder.orderOrigin}}</p>
              </li>
              <li>
                <p class="tit">客户姓名</p>
                <p class="txt">{{detailInfo.inputChannelOrder.memberName}}</p>
              </li>
              <li>
                <p class="tit">平台订单号</p>
                <p class="txt">{{detailInfo.inputChannelOrder.markSn}}</p>
              </li>
              
              <li>
                <p class="tit">实付金额</p>
                <p class="txt">{{detailInfo.inputChannelOrder.orderAmount}}</p>
              </li>
              <li>
                <p class="tit">支付时间</p>
                <p class="txt">{{detailInfo.inputChannelOrder.payTime | dateFormat}}</p>
              </li>
              <li>
                <p class="tit">收件地址</p>
                <p class="txt">{{detailInfo.inputChannelOrder.receiveAddress}}</p>
              </li>
            </ul>
            <ul class="fl">
              <li>
                <p class="tit">客户平台</p>
                <p class="txt">{{detailInfo.inputChannelOrder.custPlatform}}</p>
              </li>
              <li>
                <p class="tit">客户手机号</p>
                <p class="txt">{{detailInfo.inputChannelOrder.memberPhone}}</p>
              </li>
              
              <li>
                <p class="tit">昵称旺旺</p>
                <p class="txt">{{detailInfo.inputChannelOrder.nickname}}</p>
              </li>
              <li>
                <p class="tit">下单时间</p>
                <p class="txt">{{detailInfo.inputChannelOrder.orderTime| dateFormat}}</p>
              </li>
              <li>
                <p class="tit">邮箱</p>
                <p class="txt">{{detailInfo.subject.applyEmail}}</p>
              </li>
              <li>
                <p class="tit">备注</p>
                <p class="txt">{{detailInfo.inputChannelOrder.remark}}</p>
              </li>
            </ul>
          </div>
          <!-- <div class="basic_img fr clearfix"> -->
            ...
            <!-- <div
              class="fr mb20"
              v-if="detailInfo.inputChannelOrder.voucherUrl"
              @click="preview(voucherUrl_data[0])"
            >
              <img :src="voucherUrl_data[0]" alt />
              <p title="支付凭证">支付凭证</p>
            </div> -->
          <!-- </div> -->
        </div>
        ...
        <div class="detail_list clearfix">
          <div class="category_left fl clearfix">
            <ul class="fl">
              ...
              <li>
                <p class="tit">{{detailInfo.subject.applyType | mainBodeSbj}}营业执照号</p>
              ...
              <li>
                ...
                <p
                  class="txt"
                >{{detailInfo.subject.applyAreaInfo}}{{detailInfo.subject.applyAddress}}</p>
              </li>
            </ul>
            <ul class="fl">
              <li>
          ...
          <div class="basic_img_main fr clearfix">
            <!-- <div class="fr mb20" :class="{'ml30':!detailInfo.information.specifyPicUrl}" v-if="detailInfo.information.blackWhitePicUrl" @click="preview(detailInfo.information.blackWhitePicUrl)">
	            <img :src="detailInfo.information.blackWhitePicUrl" alt="">
	            <p title="黑白色">黑白色</p>
	          </div>
            ...
            <div
              class="fr mb30 ml30"
              v-if="detailInfo.subject.standby2"
              @click="preview(licenseName[0])"
            >
              <img :src="licenseName[0]" alt />
              <p title="营业执照">{{detailInfo.subject.applyType|licenseName}}</p>
            </div>
            <div
              class="fr mb30"
              v-if="detailInfo.subject.standby1"
              @click="preview(usinessLicense[0])"
            >
              <img :src="usinessLicense[0]" alt />
              <p title="营业执照">{{detailInfo.subject.applyType|fileName}}</p>
            </div>
      ...
      <div class="list_detail">
        ...
        <div
          class="clearfix"
          v-if="detailInfo.invoice && detailInfo.invoice.invoiceType && detailInfo.subject"
        >
          <ul class="list_left fl">
            ...
            <li
              class="mb10 clearfix"
              v-if="detailInfo.invoice.invoiceType == 2 && detailInfo.subject.applyType == 2"
            >
              <p class="left_txt fl">{{detailInfo.subject.applyType | mainBodeSbj}}地址</p>
              <p class="right_txt fl">{{detailInfo.invoice.areaInfo+detailInfo.invoice.address}}</p>
            </li>
            <li
              class="mb10 clearfix"
              v-if="detailInfo.invoice.invoiceType == 2 && detailInfo.subject.applyType == 2"
      ...
      <div
        class="basic_lists"
        v-if="detailInfo.information && detailInfo.information.trademarkName"
      >
        <p>商标注册信息</p>
        <div class="basic_category clearfix" v-if="detailInfo.information">
          <ul class="fl category_left">
            ...
            <li>
              <p class="tit">合同书</p>
              <p class="txt" v-if="detailInfo.information.contractUrl">
                <a
                  style="color:#20a0ff;"
                  :href="detailInfo.information.contractUrl"
                  target="_blank"
                >下载</a>
              </p>
            ...
            <li>
              <p class="tit">确认书</p>
              <p class="txt" v-if="detailInfo.information.confirmUrl">
                <a
                  style="color:#20a0ff;"
                  :href="detailInfo.information.confirmUrl"
                  target="_blank"
                >下载</a>
              </p>
              <p class="txt" v-else>未上传</p>
            ...
            <li>
              <p class="tit">委托书</p>
              <p class="txt" v-if="detailInfo.information.proxyUrl">
                <a style="color:#20a0ff;" :href="detailInfo.information.proxyUrl" target="_blank">下载</a>
              </p>
              <p class="txt" v-else>未上传</p>
            </li>
          </ul>
          <div class="basic_img fl clearfix">
            <div
              class="fr mb20"
              :class="{'ml30':!detailInfo.information.specifyPicUrl}"
              v-if="detailInfo.information.blackWhitePicUrl"
              @click="preview(detailInfo.information.blackWhitePicUrl)"
            >
              <img :src="detailInfo.information.blackWhitePicUrl" alt />
              <p title="黑白色">黑白色</p>
            </div>
            <div
              class="fr mr30 ml30 mb20"
              v-if="detailInfo.information.specifyPicUrl"
              @click="preview(detailInfo.information.specifyPicUrl)"
            >
              <img :src="detailInfo.information.specifyPicUrl" alt />
              <p title="指定色">指定色</p>
            </div>
            <div
              class="fr mb20"
              v-if="detailInfo.information.proxyUrl"
              @click="preview(powerAttorney[0])"
            >
      ...
      <div class="service_list">
        ...
        <div class="detail_list" v-for="(info,$index) in detailInfo.orderInformation">
          <div class="list_tit clearfix">
            ...
            <p class="fl colorblue">{{info.orderSn}}</p>
          </div>
          <ul class="mt10 clearfix" style="padding-left: 58px;">
            <li class="clearfix mb10">
              <p class="state_name fl">办理状态</p>
              <p class="state_txt fl">
                {{info.order_feedback_state}}
                <a href="#" class="view" @click.prevent="viewRecord(info)">查看详情</a>
              </p>
            </li>
            <li class="clearfix mb10">
              ...
              <p class="state_txt fl">
                共{{info.minNumber}}个小项
                <span v-if="info.minNumber">（{{info.min}}）</span>
              </p>
            </li>
            <li class="clearfix mb10">
              <p class="state_name fl">群组官方编号</p>
              <p class="state_txt fl">{{info.niceGroupGovernNums || '--'}}</p>
            </li>
            <!-- <li class="clearfix mb10">
      ...
      <div class="service">
        ...
        <div class="service_table">
          <p>
            当前服务状态：{{matchStatusName(detailInfo.status)}}
            <button
              v-if="isAllWorkOrder && detailInfo.status==12 && localStore.get('permission').indexOf('iprp_mp_channel_work_order_audit') !== -1"
              :class="{'service_btn':detailInfo.status==12}"
              class="ml10"
              @click="auditClick(detailInfo)"
            >审核</button>
            <!-- 全部工单中的审核 -->
            <!-- <button v-if="!isAllWorkOrder && detailInfo.status==10 && localStore.get('permission').indexOf('iprp_audit_material_audit') !== -1" :class="{'service_nullbtn':detailInfo.status!=10,'service_btn':detailInfo.status==10}" class="ml10" @click="auditClick(detailInfo)">审核</button> -->
            <!-- 审核材料中的审核 -->
            <!-- <button v-if="detailInfo.status==13" class="service_nullbtn ml10">已审核</button> -->
          </p>
          <ul class="table_tit clearfix" v-if="detailInfo.operationRecord.length>0">
            <li class="fl tb01" style="padding-left:20px;">操作时间</li>
            <li class="fl tb02">操作类型</li>
            <li class="fl tb03">操作人</li>
          </ul>
          <ul
            class="table_list clearfix"
            v-for="data in detailInfo.operationRecord"
            v-if="detailInfo.operationRecord.length>0"
          >
            <li class="fl tb01" style="padding-left:20px;">
              <p>{{data.operatorTime | dateFormat}}</p>
            </li>
            <li class="fl tb02">
              <p>{{data.recordContentService}}</p>
            </li>
            <li class="fl tb03">
      ...
      <el-dialog
        title="更换服务商"
        :visible.sync="setServicerVisible"
        class="setServicerDialog"
        :modal-append-to-body="true"
      >
        <el-form
          ref="setServicerData"
          :model="setServicerData"
          :rules="setServicerRules"
          :inline="false"
          auto-complete="off"
          label-width="170px"
        >
          ...
          <el-form-item label="请填写备注备注" prop="memo">
            <el-input
              ...
              type="textarea"
              :rows="5"
              v-model="setServicerData.memo"
              :maxlength="200"
              style="width: 480px;"
            ></el-input>
            <p
              class="service_limit"
              style="text-align:right;position: absolute;bottom: 0;right: 5px;height: 20px;line-height: 20px;font-size: 13px;"
            >{{setServicerData.memo && setServicerData.memo.length || 0}}-200字</p>
          </el-form-item>
          ...
          <div class="set_btn clearfix">
            ...
            <span
              class="right_btn"
              :class="{disabled: !setServicerData.isContact}"
              @click="servicerConfirm('setServicerData')"
            >确认</span>
          </div>
        </el-form>
      </el-dialog>
      ...
      >
        ...
        <div class="preview_tit mt25 mb20 ml20" v-if="previewImg">
          <p @click="previewImg = false">
            <img src="~assets/img/return.png" alt />
            预览《{{certificateImg | downFileName}}》
          </p>
        </div>
        <!-- 办理进度 -->
        <div
          class="state_list"
          v-if="!previewImg && recordData"
          v-loading="dialogServiceLoading"
          style="padding-bottom: 15px;"
        >
          <template v-if="detailInfo.workOrderType==0">
            <!-- 外部包裹 -->
            <div class="state_time" v-if="recordData[0]||!recordData[99]">
              <p :class="{'sc':recordData[0]}">
                <span class="mr10">●</span>服务单已生成
              </p>
            ...
            <template v-if="detailInfo.workOrderType==0">
              ...
              <div class="state_time" v-if="recordData[2]||!recordData[99]">
                <p :class="{'sc':recordData[2]}">
                  <span class="mr10">●</span>服务商已接单
                </p>
              ...
              <div class="state_time" v-if="recordData[3]||!recordData[99]">
                <p :class="{'sc':recordData[3]}">
                  <span class="mr10">●</span>待服务完善
                </p>
              ...
              <div class="state_time" v-if="(recordData[4]&&recordData[4].length)||!recordData[99]">
                <p :class="{'sc':recordData[4] && recordData[4].length}">
                  <span class="mr10">●</span>待用户确认信息
                </p>
                <div
                  v-if="recordData[4] && recordData[4].length"
                  v-for="itemoperate in recordData[4]"
                  style="border-left: 1px dashed #ddd;width:359px;margin-left:4px"
                >
              ...
              <div class="state_time" v-if="recordData[5]">
                <p :class="{'sc':recordData[5]}">
                  <span class="mr10">●</span>待支付加项费用
                </p>
              ...
              <div class="state_time" v-if="recordData[6]||!recordData[99]">
                <p :class="{'sc':recordData[6]}">
                  <span class="mr10">●</span>待平台审核
                </p>
              ...
              <div class="state_time" v-if="recordData[7]||!recordData[99]">
                <p :class="{'sc':recordData[7]}">
                  <span class="mr10">●</span>待申报至商标局
                </p>
            ...
            <div class="state_time" v-if="recordData[8]||!recordData[99]">
              <p :class="{'sc':recordData[8]}">
                <span class="mr10">●</span>待商标局收文
              </p>
            ...
            <div class="state_time" v-if="recordData[9]">
              <p :class="{'sc':recordData[9]}">
                <span class="mr10">●</span>待形式审查
              </p>
              <div v-for="item in recordData[9]">
                ...
                >{{item.type | downFileName}}</span>
                <a v-if="item.url" class="ml40" @click="previewClick(item)">预览</a>
                <a
                  v-if="item.url"
                  class="ml20"
                  :href="rootUrl+'/api/downFile?access_token='+token+'&url='+item.url"
                  target="_blank"
                >下载</a>
              </div>
              <i></i>
            ...
            <div class="state_time" v-if="!recordData[11]&&!recordData[99]">
              <p>
                <span class="mr10">●</span>待实质审查
              </p>
              <i></i>
            </div>
            <!-- 待实质审查 -->
            <div class="state_time" v-if="recordData[11]">
              <p :class="{'sc':recordData[11]}">
                <span class="mr10">●</span>待实质审查
              </p>
              <div v-if="recordData[11]&&recordData[11].length" v-for="info in recordData[11]">
                ...
                <span
                  class="ml40 mr515"
                  style="width:95px;display:inline-block;"
                >{{info.type | downFileName}}</span>
                <a v-if="info.url" class="ml40" @click="previewClick(info)">预览</a>
                <a
                  v-if="info.url"
                  class="ml20"
                  :href="rootUrl+'/api/downFile?access_token='+token+'&url='+info.url"
                  target="_blank"
                >下载</a>
                <i></i>
              </div>
            ...
            <div class="state_time" v-if="recordData[13]">
              <p :class="{'sc':recordData[13]}">
                <span class="mr10">●</span>待初审公告
              </p>
              <!-- 显示用户查看状态 -->
            ...
            <div class="state_time" v-if="recordData[14]">
              <p :class="{'sc':recordData[14]}">
                <span class="mr10">●</span>被驳回
              </p>
              <!-- 显示用户查看状态 -->
            ...
            <div class="state_time" v-if="recordData[16]">
              <p :class="{'sc':recordData[16]}">
                <span class="mr10">●</span>待发放注册证
              </p>
              <!-- 显示用户查看状态 -->
            ...
            <div class="state_time" v-if="recordData[17]">
              <p :class="{'sc':recordData[17]}">
                <span class="mr10">●</span>被异议
              </p>
              <!-- 显示用户查看状态 -->
            ...
            <!-- 已发放注册证 -->
            <div class="state_time" v-if="!recordData[99]">
              <p :class="{'sc':recordData[18]}">
                <span class="mr10">●</span>已发放注册证
              </p>
              <!-- 显示用户查看状态 -->
            ...
            <!-- 办理终止 -->
            <div class="state_time" v-if="recordData[99]">
              <p :class="{'sc':recordData[99]}">
                <span class="mr10">●</span>办理终止
              </p>
              <!-- 显示用户查看状态 -->
          ...
          <!-- 创新保工单的服务单办理状态 -->
          <template v-if="detailInfo.workOrderType==4">
            <!-- 服务单已生成 -->
            <div class="state_time" v-if="recordData[0]">
              ...
              <div
                v-if="recordData[0] && recordData[0].length"
                v-for="itemoperate in recordData[0]"
                style="border-left: 1px dashed #ddd;margin-left:4px"
              >
                <span class="ml20 time_left">{{itemoperate.bs_feedback_operate || '--'}}</span>
                <span class="ml40">{{itemoperate.operating_time | formatDate}}</span>
              </div>
            ...
            <div class="state_time" v-if="recordData[6]">
              <p :class="{'sc':recordData[6]}">
                <span class="mr10">●</span>已上报待审核
              </p>
              <div
                v-if="recordData[6] && recordData[6].length"
                v-for="itemoperate in recordData[6]"
                style="border-left: 1px dashed #ddd;margin-left:4px"
              >
                <span class="ml20 time_left">{{itemoperate.bs_feedback_operate || '--'}}</span>
                <span class="ml40">{{itemoperate.operating_time | formatDate}}</span>
            ...
            <div class="state_time" v-if="recordData[7]">
              <p :class="{'sc':recordData[7]}">
                <span class="mr10">●</span>已审核待申报
              </p>
              <div
                v-if="recordData[7] && recordData[7].length"
                v-for="itemoperate in recordData[7]"
                style="border-left: 1px dashed #ddd;margin-left:4px"
              >
                <span class="ml20 time_left">{{itemoperate.bs_feedback_operate || '--'}}</span>
                <span class="ml40">{{itemoperate.operating_time | formatDate}}</span>
            ...
            <div class="state_time" v-if="recordData[9]">
              ...
              <div
                v-if="recordData[9] && recordData[9].length"
                v-for="itemoperate in recordData[9]"
                style="border-left: 1px dashed #ddd;margin-left:4px"
              >
                <span class="ml20 time_left">{{itemoperate.bs_feedback_operate || '--'}}</span>
                <span class="ml40">{{itemoperate.operating_time | formatDate}}</span>
                <span
                  class="ml40 mr515"
                  style="width:95px;display:inline-block;"
                >{{itemoperate.type | downFileName}}</span>
                <a v-if="itemoperate.url" class="ml40" @click="previewClick(itemoperate)">预览</a>
                <a
                  v-if="itemoperate.url"
                  class="ml20"
                  :href="rootUrl+'/api/downNetFile?access_token='+token+'&url='+itemoperate.url"
                  target="_blank"
                >下载</a>
              </div>
              <i style="margin-top: 0;height: 20px;"></i>
            ...
            <div class="state_time" v-if="recordData[10]">
              <p :class="{'sc':recordData[10]}">
                <span class="mr10">●</span>待形式审查
              </p>
              <!-- 显示用户查看状态 -->
              <div
                v-if="recordData[10] && recordData[10].length"
                v-for="itemoperate in recordData[10]"
                style="border-left: 1px dashed #ddd;margin-left:4px"
              >
                <span class="ml20 time_left">{{itemoperate.bs_feedback_operate || '--'}}</span>
                <span class="ml40">{{itemoperate.operating_time | formatDate}}</span>
            ...
            <div class="state_time" v-if="recordData[11]">
              ...
              <div
                v-if="recordData[11]&&recordData[11].length"
                v-for="info in recordData[11]"
                style="border-left: 1px dashed #ddd;margin-left:4px"
              >
                ...
                <a
                  v-if="info.url"
                  class="ml20"
                  :href="rootUrl+'/api/downNetFile?access_token='+token+'&url='+info.url"
                  target="_blank"
                >下载</a>
              </div>
              <i style="margin-top: 0;height: 20px;"></i>
            ...
            <div class="state_time" v-if="recordData[13]">
              ...
              <!-- 显示用户查看状态 -->
              <div
                v-if="recordData[13]&&recordData[13].length"
                v-for="info in recordData[13]"
                style="border-left: 1px dashed #ddd;margin-left:4px"
              >
                <span class="ml20 time_left">{{info.bs_feedback_operate || '--'}}</span>
                <span class="ml40">{{info.operating_time | formatDate}}</span>
            ...
            <div class="state_time" v-if="recordData[14]">
              ...
              <!-- 显示用户查看状态 -->
              <div
                v-if="recordData[14]&&recordData[14].length"
                v-for="info in recordData[14]"
                style="border-left: 1px dashed #ddd;margin-left:4px"
              >
                <span class="ml20 time_left">{{info.bs_feedback_operate || '--'}}</span>
                <span class="ml40">{{info.operating_time | formatDate}}</span>
            ...
            <div class="state_time" v-if="recordData[19]">
              ...
              <!-- 显示用户查看状态 -->
              <div
                v-if="recordData[19]&&recordData[19].length"
                v-for="info in recordData[19]"
                style="border-left: 1px dashed #ddd;margin-left:4px"
              >
                <span class="ml20 time_left">{{info.bs_feedback_operate || '--'}}</span>
                <span class="ml40">{{info.operating_time | formatDate}}</span>
            ...
            <div class="state_time" v-if="recordData[12]||!recordData[99]">
              ...
              <!-- 显示用户查看状态 -->
              <div
                v-if="recordData[12]&&recordData[12].length"
                v-for="info in recordData[12]"
                style="border-left: 1px dashed #ddd;margin-left:4px"
              >
                <span class="ml20 time_left">{{info.bs_feedback_operate || '--'}}</span>
                <span class="ml40">{{info.operating_time | formatDate}}</span>
            ...
            <div class="state_time" v-if="recordData[16]">
              ...
              <!-- 显示用户查看状态 -->
              <div
                v-if="recordData[16]&&recordData[16].length"
                v-for="info in recordData[16]"
                style="border-left: 1px dashed #ddd;margin-left:4px"
              >
                <span class="ml20 time_left">{{info.bs_feedback_operate || '--'}}</span>
                <span class="ml40">{{info.operating_time | formatDate}}</span>
            ...
            <div class="state_time" v-if="recordData[17]">
              ...
              <!-- 显示用户查看状态 -->
              <div
                v-if="recordData[17]&&recordData[17].length"
                v-for="info in recordData[17]"
                style="border-left: 1px dashed #ddd;margin-left:4px"
              >
                <span class="ml20 time_left">{{info.bs_feedback_operate || '--'}}</span>
                <span class="ml40">{{info.operating_time | formatDate}}</span>
            ...
            <div class="state_time" v-if="recordData[22]">
              ...
              <!-- 显示用户查看状态 -->
              <div
                v-if="recordData[22]&&recordData[22].length"
                v-for="info in recordData[22]"
                style="border-left: 1px dashed #ddd;margin-left:4px"
              >
                <span class="ml20 time_left">{{info.bs_feedback_operate || '--'}}</span>
                <span class="ml40">{{info.operating_time | formatDate}}</span>
            ...
            <div class="state_time" v-if="!recordData[99]">
              ...
              <!-- 显示用户查看状态 -->
              <div
                v-if="recordData[15]&&recordData[15].length"
                v-for="info in recordData[15]"
                style="border-left: 1px dashed #ddd;margin-left:4px"
              >
                <span class="ml20 time_left">{{info.bs_feedback_operate || '--'}}</span>
                <span class="ml40">{{info.operating_time | formatDate}}</span>
            ...
            <div class="state_time" v-if="!recordData[99]">
              ...
              <!-- 显示用户查看状态 -->
              <div
                v-if="recordData[18]&&recordData[18].length"
                v-for="info in recordData[18]"
                style="border-left: 1px dashed #ddd;margin-left:4px"
              >
                <span class="ml20 time_left">{{info.bs_feedback_operate || '--'}}</span>
                <span class="ml40">{{info.operating_time | formatDate}}</span>
            ...
            <div class="state_time" v-if="recordData[99]">
              ...
              <!-- 显示用户查看状态 -->
              <div
                v-if="recordData[99]&&recordData[99].length"
                v-for="info in recordData[99]"
                style="border-left: 1px dashed #ddd;margin-left:4px"
              >
                <span class="ml20 time_left">{{info.bs_feedback_operate || '--'}}</span>
                <span class="ml40">{{info.operating_time | formatDate}}</span>
      ...
      >
        <p class="mt10 mb10">备注：</p>
        <el-input class="service_note" type="textarea" :rows="5" v-model="content" :maxlength="200"></el-input>
...
const detailUrl = "./api/findChannelWorkOrderDetail";

const auditUrl = "./api/auditChannelWorkOrder";
...
export default {
  data() {
    return {
      ...
      setServicerRules: {
        spId: [{ required: true, message: "请选择服务商", trigger: "blur" }],
        isContact: [
          {
            type: "boolean",
            required: true,
  ...
  methods: {
    ...
    //支付凭证pdf转jpg
    previewVoucherUrl(url) {
      this.$http
        .get("./api/preview?pdf_url=" + url)
        .then(response => {
          this.voucherUrl_data = response.data.urls;
        })
        .catch(error => {
          console.log(error);
        });
    ...
    viewRecord(recordData) {
      ...
      this.$http
        .get("./api/findBsFeedbackCode?orderSn=" + recordData.orderSn)
        .then(response => {
    ...
    servicerConfirm(name) {
      ...
      this.$refs[name].validate(valid => {
        if (valid) {
          this.$http
            .put(
              allotSpUrl.replace("{work_order_sn}", this.$route.params.id),
              data
            )
            .then(resp => {
              this.$message({
    ...
    getRemark() {
      this.$http
        .get(getRemarkUrl.replace("work_order_sn", this.work_order_sn))
        .then(resp => {
    ...
    search() {
      var self = this;
      this.$http
        .get(detailUrl + "/" + this.$route.params.id)
        .then(resp => {
          self.detailInfo = resp.data;
          if (self.detailInfo.operationRecord[0]) {
            self.recordContent =
              self.detailInfo.operationRecord[0].recordContentService;
          }
          //支付凭证
          if (self.detailInfo.inputChannelOrder.voucherUrl) {
            self.previewVoucherUrl(
              self.detailInfo.inputChannelOrder.voucherUrl
            );
          }
          // 营业执照
  ...
  mounted() {
    ...
    this.type = this.$route.params.state;
