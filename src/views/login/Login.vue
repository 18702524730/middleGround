...
html,body,#app{height:100%;}
	.login{background: url(~assets/img/banner.jpg) no-repeat;width: 100%;height: 100%;padding: 40px 60px 60px;min-height: 800px;min-width: 1200px;background-size: cover;position: relative;
		.header_left{
			p{display: inline-block;font-size: 16px;color: #FFFFFF;vertical-align: bottom;line-height: 26px;}
