...
<script>
	...
	const workOrderListUrl = './api/findPasInvoiceList4YearToBeInvoiced';
	const dataObj = {//条件数据
		// contractNo:null,
		patentName:null,
		applicant: null,
  ...
  export default {
    ...
    methods: {
      ...
      view(item){
      	this.$router.push({name: 'unmailedyearInvoiceDetail', params: {id: item.caseSysNo,type:item.patentType}})
      },
