  ...
  <div class="patentdetail">
    ...
    <div class="form">
      <template >
        ...
        <div class="basic_lists">
          <div class="basictitle">
            ...
            <el-button type="primary" @click="openDailog('add','sqf')" class = 'fr' v-if="!detailInfo.pasExpressInfoForm.expressId">录入快递信息</el-button>
          </div>
      ...
      <el-dialog :title="mailtitle" :visible.sync="isapplymail" class="state_preview">
        ...
        <div class="btnbox">
          <el-button size="large" type="primary" @click="commonSubmit('add')">确定</el-button>
