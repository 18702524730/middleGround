...
<script>
	...
	const workOrderListUrl = './api/findPasInvoiceList4ApplicatToBeMailed';
  ...
  export default {
    ...
    methods: {
      ...
      view(item){
      	this.$router.push({name: 'unmailedDetail', params: {id: item.caseSysNo,type:1}})
      },
