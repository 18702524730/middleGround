	  ...
	  <div class="result">
        ...
        <tbody class="tr-color">
          <tr v-for="(item, index) in dataList" v-show="!loading && dataList.length">
			...
			<td class="nopay">{{item.rejectReviewDeadline|dateFormat}}</td>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      view(item){
      	this.$router.push({name: 'rejectedSubDetail', params: {id: item.caseSysNo,step:210}})
      },
