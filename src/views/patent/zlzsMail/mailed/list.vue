	  ...
	  <div class="result">
        ...
        <thead>
          <tr class="thead">
			...
			<th class="smWidth">授权日</th>
			<th class="smWidth">授权公开号</th>
			<th class="smWidth">收证日期</th>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      view(item){
      	this.$router.push({name: 'zlzsmailedDetail', params: {id: item.caseSysNo,type:2}})
      },
