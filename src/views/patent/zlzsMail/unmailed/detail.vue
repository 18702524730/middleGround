<template>
  <div class="patentdetail">
    ...
    <div class="form">
      <template >
        ...
        <div class="basic_lists">
          <div class="basictitle">
            ...
            <el-button type="primary" @click="openDailog('zlzs')" class = 'fr' v-if="!detailInfo.obtainCertificate">录入快递信息</el-button>
          </div>
          <div class="basic_category" v-if="detailInfo.obtainCertificate">
            <ul>
                  <li v-if="!!detailInfo.obtainCertificate.authTime">
                    <p class="tit">授权日：</p>
                    <p class="txt">{{detailInfo.obtainCertificate.authTime|dateFormat}}</p>
                  </li>
                  <li v-if="!!detailInfo.obtainCertificate.authPublicNumber">
                    <p class="tit">授权公开号：</p>
                    <p class="txt">{{detailInfo.obtainCertificate.authPublicNumber}}</p>
                  </li>
                  <li v-if="detailInfo.obtainCertificate.receiveCertificateTime">
                    <p class="tit">收证日期：</p>
                    <p class="txt">{{detailInfo.obtainCertificate.receiveCertificateTime|dateFormat}}</p>
                  </li>
                  <li v-if="detailInfo.obtainCertificate.sendType">
                    <p class="tit">寄送方式：</p>
      ...
      <!-- 专利证书邮寄信息 -->
      <el-dialog title="专利证书邮寄信息" :visible.sync="is_pletter" class="state_preview">
