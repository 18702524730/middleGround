        ...
        <div v-if="detailInfo.pasInvoiceInfoFormList">
          ...
          <!-- 上传申请材料 -->
            <div class="basic_lists"  v-if="detailInfo.pasFlowFeedbackMap[1] || detailInfo.currentFlowStage==1">
              <div class="basictitle">
                ...
                <div class = 'fr'>
                  <el-button type="primary" @click="uploadMaterial('u','standby1')" v-if="detailInfo.currentFlowStage==1">上传</el-button>
                </div>
          ...
          <!-- 受理通知 -->
            <div class="basic_lists" v-if="detailInfo.pasFlowFeedbackMap[2] || detailInfo.currentFlowStage==2" >
              <div class="basictitle">
                ...
                <div class = 'fr'>
                  <el-button type="primary" @click="uploadMaterial('u','standby2')" v-if="detailInfo.currentFlowStage==2">上传</el-button>
                </div>
          ...
          <!-- 申请费缴纳 -->
            <div class="basic_lists" v-if="detailInfo.pasFlowFeedbackMap[3] || detailInfo.currentFlowStage==3">
              <div class="basictitle">
                ...
                <div class = 'fr'>
                  <el-button type="primary" @click="uploadMaterial('u','standby3')" v-if="detailInfo.currentFlowStage==3">缴纳</el-button>
                </div>
          ...
          <div class="basic_lists" v-if="detailInfo.pasFlowFeedbackMap[4] || detailInfo.currentFlowStage==4"  >
            <div class="basictitle">
              ...
              <div class = 'fr'>
                <el-button type="primary" @click="uploadMaterial('u','standby4')" v-if="detailInfo.currentFlowStage==4">反馈</el-button>
              </div>
          ...
          <div class="basic_lists" v-if="detailInfo.pasFlowFeedbackMap[5] || detailInfo.currentFlowStage==5">
            <div class="basictitle">
              ...
              <div class = 'fr'>
                <el-button type="primary" @click="uploadMaterial('u','standby5')" v-if="detailInfo.currentFlowStage==5">上传补正材料</el-button>
              </div>
          ...
          <div v-if="detailInfo.pasFlowFeedbackMap[6] || detailInfo.currentFlowStage==6">
            <div class="basic_lists">
              <div class="basictitle">
                ...
                <div class = 'fr'>
                  <el-button type="primary" @click="uploadMaterial('u','ssresult')" v-if="detailInfo.currentFlowStage==6">反馈审核结果</el-button>
                </div>
              </div>
          ...
          <div class="basic_lists" v-if="detailInfo.pasFlowFeedbackMap[7] || detailInfo.currentFlowStage==7">
            <div class="basictitle">
              ...
              <div class = 'fr'>
                <el-button type="primary" @click="uploadMaterial('u','standby4ss')" v-if="detailInfo.currentFlowStage==7">反馈实质审查结果</el-button>
              </div>
          ...
          <div class="basic_lists" v-if="detailInfo.pasFlowFeedbackMap[8] || detailInfo.currentFlowStage==8">
            <div class="basictitle">
              ...
              <div class = 'fr'>
                <el-button type="primary" @click="uploadMaterial('u','standby5ss')" v-if="detailInfo.currentFlowStage==8">上传补正材料</el-button>
              </div>
          ...
          <div  v-if="detailInfo.pasFlowFeedbackMap[9] || detailInfo.currentFlowStage==9">
            <div class="basic_lists" >
              <div class="basictitle">
                ...
                <div class = 'fr'>
                  <el-button type="primary" @click="uploadMaterial('u','standby6')"  v-if="detailInfo.currentFlowStage==9">缴纳</el-button>
                </div>
              </div>
            ...
            <el-form-item class="pingzheng" label="付款凭证" prop="pingzheng">
              <div class="upload_component" style="margin-bottom:20px;">
                ...
                <div class="upload_tip">
                  ...
                  <!-- <p class="format">备注：特殊情况可以上传支付凭证</p> -->
                </div>
              </div>
            </el-form-item>
          </el-form>
