      ...
      <el-dialog :title="standby3_title" :visible.sync="is_standby3" class="state_preview">
        <div class="reviseapplybox">
          <el-form ref="standby3_Datas" label-width="130px" :model="standby3_Datas">
              ...
              <el-input type="number" v-model="standby3_Datas.turnInApplicatFee" placeholder="请填写缴纳官费金额" :maxlength="20" :min="0"></el-input>
            </el-form-item>
          ...
          <el-form ref="standby4_Datas" label-width="120px" :model="standby4_Datas">
            ...
            <div v-if="standby4_Datas.trialReviewResult==1">
              ...
              <el-form-item class="submitdate" label="第几年度年费" prop="whichYear">
                <!-- <el-input type="number" v-model="standby4_Datas.whichYear" placeholder="请填写年度" :maxlength="20" :min="1" :max='10'></el-input> -->
        ...
        <div class="reviseapplybox">
          <el-form ref="standby6_Datas" label-width="130px" :model="standby6_Datas">
            <el-form-item class="boardFeeReceiveAmount" label="办登费收款金额（元）" prop="boardFeeReceiveAmount">
              <el-input type="number" v-model="standby6_Datas.boardFeeReceiveAmount" placeholder="请填写办登费收款金额" :maxlength="20" :min="0"></el-input>
            </el-form-item>
            <el-form-item class="serviceFee" label="服务费（元）" prop="serviceFee">
              <el-input type="number" v-model="standby6_Datas.serviceFee" placeholder="请填写服务费金额" :maxlength="20" :min="0"></el-input>
            </el-form-item>
            ...
            <el-form-item class="turnInAmount" label="缴费金额（元）" prop="turnInAmount">
              <el-input type="number" v-model="standby6_Datas.turnInAmount" placeholder="请填写缴费金额" :maxlength="20" :min="0"></el-input>
            </el-form-item>
        ...
        <div class="reviseapplybox">
          <el-form ref="standby7_Datas" label-width="110px"  :model="standby7_Datas">
            ...
            <el-form-item class="amount" :label="`第${num}年年费收款金额（元）`" prop="yearFeeReceiveAmount">
              <el-input type="number" v-model="standby7_Datas.yearFeeReceiveAmount" placeholder="请填写年费收款金额" :maxlength="20" :min="0"></el-input>
            </el-form-item>
            <el-form-item class="serviceamount" label="服务费（元）" prop="serviceFee">
              <el-input type="number" v-model="standby7_Datas.serviceFee" placeholder="请填写年费收款金额" :maxlength="20" :min="0"></el-input>
            </el-form-item>
            ...
            <el-form-item class="amounts" label="缴费金额" prop="turnInAmount">
              <el-input type="number" v-model="standby7_Datas.turnInAmount" placeholder="请填写缴费金额" :maxlength="20" :min="0"></el-input>
            </el-form-item>
...
export default {
  ...
  methods: {
    ...
    torevise() {
      ...
      this.$router.push({
        name: "reviseBasic",
        params: { state: this.caseSysNo,type:1 }
      });
    },
