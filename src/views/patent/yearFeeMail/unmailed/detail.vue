      ...
      <template >
        ...
        <div class="basic_lists">
          <div class="basictitle">
            ...
            <el-button type="primary" @click="openDailog('add','nf')" v-if="detailInfo.pasExpressInfoForm.yearFeeTurnInType==1&&detailInfo.pasExpressInfoForm.invoiceForm!=1" class = 'fr'>录入快递信息</el-button>
          </div>
