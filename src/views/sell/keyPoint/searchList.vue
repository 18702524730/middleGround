<template>
  <div class="workCommonList clientServiceOrder">
	  <div class="condition clearfix">
	  	...
	  	<div class="form_control"><el-input v-model="searchObj.saleName" placeholder="客户姓名"></el-input></div>
			<div class="form_submit">
				<button class="submit" @click="getSearchListFn(); currentPage = 1;">搜索</button>
    ...
    methods: {
      ...
      getSearchListFn () {
        let params = {
          ...
          userAccount: this.searchObj.memberSn,
          weixinNickname: this.searchObj.nickname,
          userName: this.searchObj.saleName
        }
        this.loading = true;
